...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _tableTitleFont             = [UIFont systemFontOfSize:10];
...
-(void)drawRect:(CGRect)rect{
    ...
    if (_colTitleArr.count>0) {
        ...
        for (NSInteger i = 0; i<_colTitleArr.count; i++) {
            ...
            CGSize size = [self sizeOfStringWithMaxSize:CGSizeMake(wid, _minHeightItems) textFont:12 aimString:_colTitleArr[i]];
            ...
            if (i==0) {
                ...
                if (firArr.count>=2) {
                    ...
                    size = [self sizeOfStringWithMaxSize:CGSizeMake(wid, _minHeightItems) textFont:12 aimString:firArr[0]];
                    ...
                    size = [self sizeOfStringWithMaxSize:CGSizeMake(wid, _minHeightItems) textFont:12 aimString:firArr[1]];
                    ...
                    [self drawText:_colTitleArr[i] context:context atPoint:CGRectMake(lastX + wid / 2.0 - size.width / 2, _lastY + _minHeightItems / 2.0 -size.height / 2.0, wid, size.height) WithColor:_bodyTextColor font:[UIFont systemFontOfSize:12]];;
                }
                
                
            }else{
            
                [self drawText:_colTitleArr[i] context:context atPoint:CGRectMake(lastX + wid / 2.0 - size.width / 2, _lastY + _minHeightItems / 2.0 -size.height / 2.0, wid, _minHeightItems) WithColor:_bodyTextColor font:[UIFont systemFontOfSize:12]];;
            }
            lastX += wid;
